<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CapNhatTTTaiKhoan.ascx.cs" Inherits="DeTaiQuanLyBanHang.cms.TrangNhanVien.CapNhatTTTaiKhoan" %>
<style>
    .Input{
        padding:4px;
    }
...
<table style="margin-left:37%">
    ...
    <tr class="row">
        <td class="Lable"></td>
        <td>
            <asp:Button ID="btnDatHang" runat="server" Text="Cập nhật" class="btnThemMoi" OnClick="btnDatHang_Click" />
        </td>
