    ...
    public partial class DanhSachDonHang : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (Request.QueryString["MaKH"] == null)
            {
                ...
                DataTable tbCHITIETDONHANGG = DAO.getTable("SELECT * FROM dbo.CHITIETDONHANG, dbo.SANPHAM WHERE dbo.CHITIETDONHANG.MASP = dbo.SANPHAM.MASP AND MADONHANG='"+ MaDonHang + "'");
