<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemMoiSP.ascx.cs" Inherits="DeTaiQuanLyBanHang.cms.admin.SanPham.ThemMoiSP" %>
...
<table>
    ...
    <tr class="row">
        <td class="Lable"><span>Chọn ảnh sản phẩm:</span></td>
        <td class="Input"><asp:FileUpload ID="fileAnh" runat="server" class="Input" style="cursor:pointer;"  placeholder="Chọn hình ảnh"/></td>
        <td><asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="fileAnh" runat="server" ErrorMessage="Vui lòng chọn ảnh sản phẩm" Text="*" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator></td>
