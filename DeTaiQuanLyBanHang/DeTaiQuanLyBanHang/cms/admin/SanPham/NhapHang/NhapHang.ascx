<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhapHang.ascx.cs" Inherits="DeTaiQuanLyBanHang.cms.admin.SanPham.NhapHang.NhapHang" %>
<asp:Label ID="LableTieuDe" runat="server" ></asp:Label>
<table>
    

    <tr class="row">
        <td class="Lable"> <span >Số hóa đơn:</span></td>
        <td class="Input"><asp:TextBox ID="txtSoHoaDon" runat="server" class="Input"  placeholder="Số hóa đơn"></asp:TextBox></td>
        <td><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Vui lòng nhập số hóa đơn" Text="*" ForeColor="Red" ControlToValidate="txtSoHoaDon" SetFocusOnError=true></asp:RequiredFieldValidator></td>
    </tr>
    ...
    <tr class="row">
        ...
        <td class ="Choice"><asp:Button ID="btnChoiceDay" runat="server" Text="" class="btnChoiceDay" CausesValidation="False" OnClick="btnChoiceDay_Click"/>
            <asp:Calendar ID="Calendar" runat="server" OnSelectionChanged="Calendar_SelectionChanged" class="Calendar" BackColor="White" BorderColor="Black" BorderStyle="Solid" CellSpacing="1" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="250px" Width="304px" OnVisibleMonthChanged="Calendar_VisibleMonthChanged" VisibleDate="1/1/0001">
    ...
    <tr class="row">
        <td class="Lable"></td>
        <td>
            <asp:Button ID="btnNhap" runat="server" Text="Tiến hành nhập" CssClass="btnThemMoi" OnClick="btnNhap_Click" />
        </td>
    </tr>
    <tr class="row">
